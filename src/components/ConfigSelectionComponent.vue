...
const exteriorSections: ExteriorSection<availableCarParts>[] = [
  {
    ...
    options: [
      { label: 'Black', value: 'black', priceUsd: PRICE_BODY_COLOR.black },
      { label: 'White', value: 'white', priceUsd: PRICE_BODY_COLOR.white },
      { label: 'Blue', value: 'blue', priceUsd: PRICE_BODY_COLOR.blue },
      { label: 'Red', value: 'red', priceUsd: PRICE_BODY_COLOR.red },
      { label: 'Silver', value: 'silver', priceUsd: PRICE_BODY_COLOR.silver },
    ],
  },
  {
    title: 'Rims',
  ...
  },
  {
    ...
    options: [
      { label: 'Black', value: 'black', priceUsd: PRICE_CALIPERS_COLOR.black },
      { label: 'Blue', value: 'blue', priceUsd: PRICE_CALIPERS_COLOR.blue },
      { label: 'Grey', value: 'grey', priceUsd: PRICE_CALIPERS_COLOR.grey },
      { label: 'Red', value: 'red', priceUsd: PRICE_CALIPERS_COLOR.red },
      { label: 'Yellow', value: 'yellow', priceUsd: PRICE_CALIPERS_COLOR.yellow },
    ],
  },
  {
    title: 'Window tint',
    ...
    options: [
      { label: 'Black', value: 'black', priceUsd: PRICE_WINDOW_TINT.black },
      { label: 'Grey', value: 'grey', priceUsd: PRICE_WINDOW_TINT.grey },
      { label: 'Silver', value: 'silver', priceUsd: PRICE_WINDOW_TINT.silver },
      { label: 'White', value: 'white', priceUsd: PRICE_WINDOW_TINT.white },
    ],
  },
  {
    title: 'Side mirrors',
    ...
    options: [
      { label: 'Black', value: 'black', priceUsd: PRICE_MIRRORS_COLOR.black },
      { label: 'White', value: 'white', priceUsd: PRICE_MIRRORS_COLOR.white },
      { label: 'Blue', value: 'blue', priceUsd: PRICE_MIRRORS_COLOR.blue },
      { label: 'Red', value: 'red', priceUsd: PRICE_MIRRORS_COLOR.red },
      { label: 'Silver', value: 'silver', priceUsd: PRICE_MIRRORS_COLOR.silver },
    ],
  },
  {
    title: 'Engine',
    ...
    options: [
      { label: '2.0 TSI 245 HP', value: '2.0 TSI 245 HP', priceUsd: PRICE_ENGINE['2.0 TSI 245 HP'] },
      { label: '2.0 TSI 300 HP', value: '2.0 TSI 300 HP', priceUsd: PRICE_ENGINE['2.0 TSI 300 HP'] },
      { label: '2.0 TSI 320 HP', value: '2.0 TSI 320 HP', priceUsd: PRICE_ENGINE['2.0 TSI 320 HP'] },
    ],
  },
  {
    title: 'Gearbox',
    ...
    options: [
      { label: 'Manual', value: 'Manual', priceUsd: PRICE_GEARBOX.Manual },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'AWD 4Motion', value: 'AWD 4Motion', priceUsd: PRICE_DRIVE['AWD 4Motion'] },
    ],
  },
];
...
const interiorSections: InteriorSection<string>[] = [
  {
    ...
    options: [
      { label: 'Leather', value: 'Leather', priceUsd: PRICE_SEAT_TONE.Leather },
      { label: 'Alcantara', value: 'Alcantara', priceUsd: PRICE_SEAT_TONE.Alcantara },
    ],
  },
  {
    title: 'Screen color',
    ...
    options: [
      ...
      { label: 'White', value: 'White', priceUsd: PRICE_SCREEN_COLOR.White },
      { label: 'Green', value: 'Green', priceUsd: PRICE_SCREEN_COLOR.Green },
    ],
  },
];
...
const addOnPriceUsd = computed(() => {
  ...
  const calipers = getPrice(PRICE_CALIPERS_COLOR, configuratorStore.calipersConfig.color);
  const windows = getPrice(PRICE_WINDOW_TINT, configuratorStore.windowsConfig.color);
  const mirrors = getPrice(PRICE_MIRRORS_COLOR, configuratorStore.sideMirrorsConfig.color);
  ...
  return body + rims + calipers + windows + mirrors + engine + gearbox + drive + seat + screen;
});
...
<template>
  <div class="right-side-config-container panel-layout">
    <div class="panel-header">
      ...
      <div class="camera-switch-wrap">
        <div class="option-grid camera-switch-grid">
          <button
              :class="{ selected: sceneStore.cameraView === 'EXTERIOR' }"
          ...
          <button
              :class="{ selected: sceneStore.cameraView === 'INTERIOR' }"
    ...
    <div class="panel-scroll">
        ...
        <div v-for="section in exteriorSections" :key="section.title" class="config-section">
          ...
          <div class="option-grid">
            <button
                ...
                @click="configuratorStore.setCarPartValue(section.carPart, option.value)"
            >
      ...
      <template v-else>
        <div v-for="section in interiorSections" :key="section.title" class="config-section">
          <h2>{{ section.title }}</h2>
    ...
    <div class="panel-footer">
      <div class="pricing-rows">
        <div class="pricing-row">
          ...
          <div class="pricing-value">{{ formatUsd(BASE_PRICE_USD) }}</div>
        </div>
        <div class="pricing-row">
          <div class="pricing-label">Options</div>
          <div class="pricing-value">{{ formatUsd(addOnPriceUsd) }}</div>
        </div>
